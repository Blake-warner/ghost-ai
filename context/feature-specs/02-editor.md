- left, center, and right sections. We need the base chrome components that from every editor screen - the top navbar and the left sidebar shell. These will be reused and extended in every chapter that follows.
